  ...
  const PinEditAndDelete = () => {
    return (
      <div className={classes.pinDeletePos}>
        {user.isAdmin ? (
          <Button // Only check for admin for pins
            variant="contained"
            color="secondary"
        ...
        {checkId(user.id, senderId) || user.isAdmin ? (
          <div>
            <Button // Check if user is admin or current user owns the item
              variant="contained"
              color="secondary"
            ...
            {editMode ? (
              <Button
                ...
                classes={{
                  ...
                  disabled: classes.acceptBtnDisabled,
                }}
      ...
      <Dialog fullScreen open={open} TransitionComponent={Transition}>
        ...
        <div className={classes.root}>
          ...
          <Typography
            ...
            className={classes.subHeader}
          >
            On: <Moment format="DD/MM/YYYY" date={date} /> at{" "}
